    ...
    <div>
      ...
      <div className='page'>
        <div className='content'>
          ...
          <p className='container text-center mt-5 head'>Google Developers Groups Siliguri</p>
          <p className='container text-center head-1'>The Community of Developers, For Developers, By Developers</p>
          <br />
